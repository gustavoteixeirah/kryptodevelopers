...
const NavBar = () => {
  ...
  return (
    <nav className={`w-full fixed md:absolute z-10 ${showMobileMenu ? 'bg-gray-900' : ''}`}>
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-between px-8 items-center h-24 md:h-36 gap-8">
          <div className="md:hidden">
            <button className="p-3 active:bg-gray-800 rounded-full" onClick={toggleMobileMenu}>
              <GiHamburgerMenu />
            </button>
          </div>
          <div className="text-lg lg:text-2xl font-semibold">KDEV</div>
        ...
        >
          <div className="flex flex-col gap-2 justify-center text-md px-8 pb-8">
            ...
            <NavBarLink href="#description" onClick={toggleMobileMenu}>
              Description
            </NavBarLink>
